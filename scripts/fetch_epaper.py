...
KNOWN_AUTHORS = {
    ...
    # 20260820 新增（审核确认）
    "刘华生", "刘艳英", "吕晓伟", "夏全亮", "夏华聪", "平耀东", "张建清", "李舟",
    "杨一帆", "杨洪辉", "林雯", "梁文栋", "王芬", "王雪纯", "董雪莹", "贺鑫",
    "郝静", "陆青", "陈利珍", "陈梦羽", "韩冬", "黄翔",

    # 20260824 新增（审核确认）
    "丁成慧", "任绍铭", "余德政", "刘雯", "周鹏", "孙俊芳", "庄潇然", "庞隆", "廖云琛",
    "张嘉桐", "张容菁", "张鑫", "徐墨", "忻媛", "朱保美", "李艳芳", "杨光宇", "林志桃",
    "樊永富", "汤宝秀", "沈亮", "王再成", "王春华", "王玉景", "王继辉", "王艺萱",
    "王超群", "白玉莲", "胡姝旸", "苏有琦", "裴海瀛", "许霞", "赵丹", "郑彤", "马艳",
    "马锋", "高向阳",
    "刘奕辰", "叶平", "吴生令", "姜志斌", "张琼雄", "张雪", "徐琼芳", "朱家宁", "朱金", "杜小双",
    "杨玉辉", "柳志慧", "沈坤玉", "潘登", "王亚南", "王晓堂", "王秋云", "董航宇", "袁子扬", "谢鹏宇",
    "车小敏", "连振鸿", "陆雅君", "黄超",
    ...
    # 20260623 新增（审核确认）
    "刘翰晨", "巩力源", "张天航", "张鸿雁", "戴明晶", "李渊", "林宇香", "林艳兰",
    "柳荐秋", "水静", "王曼丽", "王玮琦", "谭政华", "赵志泉", "那晓丹", "陆波",
    "陈志立", "陈英俊", "黄诗敏", "黄锐",

    # 20260624 新增（审核确认）
    "伍露", "余嵩云", "刘双", "刘珊", "姜浩", "宁忠华", "庞君如", "张云飞",
    "张益", "张祖熠", "徐梦雪", "李晓婷", "杨光", "林城", "林海", "王豆",
    ...
    # 20260904 新增（审核确认）
    "丰婷婷", "于楠", "付杰", "信飞", "冀坤", "刘东明", "刘婧楠",
    "刘若岚", "刘英轶", "卢宇丹", "史洪杰", "向影", "吴徐燕", "吴砚威",
    "唐颖潇", "姜晓辉", "孙怡", "孙明", "孙朝锋", "宋卫星", "尹远渊",
    "张婉莹", "张慧", "张明洁", "张春同", "张琳", "张翰林", "文伟",
    "文彬", "时晓曚", "曲梓祎", "朱丽云", "朱秋宇", "李勇", "李斌喜",
    "李晓东", "李铭", "李鸿强", "杨明灿", "杨春凤", "梅健", "汪小计",
    "汪磊", "沈斌", "沈沛丰", "王俊琰", "王寒", "王建林", "王明宏",
    "王飞", "罗永明", "罗江珊", "董海涛", "董祥寿", "詹华斌", "许向春",
    "谢啸天", "费良建", "贺琳清", "贺金芳", "赵卢霞", "赵洋平", "邢俊",
    ...
    # 20260914 新增（审核确认）
    "杨丽蓉", "张顺", "李裴蓓", "刘朝阳", "吴桐", "陈林琳", "马晓珍",
    "李美竹", "杨贤明", "赵琦", "杨勇", "宝斯琴", "林联发", "赵冀雅",
    "杨彦忠", "经小美", "孙姣", "张剑明",

    # 20260915 新增（审核确认）
    "何冬菁", "刘俊宏", "刘梦", "孔月蕾", "孙悦", "常悦悦", "李国芳", "祝蓝蓝",

    # 20260916 新增（审核确认）
    "付首玲", "余迪", "刘程", "卢炳夫", "张勇", "张涵", "张芳萍", "曲永苋",
    "李月高", "李美瑜", "李银菊", "林菁", "潘元进", "王旭海", "王明华", "王玄芝",
    "王若嘉", "王莹", "田一笑", "莫建飞", "蓝浩宸", "郑浩均", "郝蓉琳", "闫景鹏",
    "陆语", "雷洲",

    # 20260917 新增（审核确认）
    "丁咚", "侯时杰", "刘国乐", "刘晓梅", "吕琳玉", "吴晓", "唐玉强", "唐白冰",
    "张昊", "张洪广", "李双巧", "李建业", "李渝平", "李美", "梁超", "沈玥琪",
    "罗润", "莫丽阳", "郝漫琪", "陈尚云", "黄光瑞",

    # 20260918 新增（审核确认）
    "任曙霞", "刘姝君", "刘辉", "单浩琦", "周卓然", "周艳丽", "李嘉昂", "杨娜", "杨玲",
    "林奥", "林晓萌", "段晓凤", "沈思艺", "洪彬彬", "王宇环", "王明江", "王琦雷",
    "白咏玉", "肖莲媛", "葛瑞婷", "薛琦", "谢婷婷", "路启民", "郭彪", "鄢卉平", "黄照亮",

    # 20260921 新增（审核确认）
    "刘翥", "叶晓春", "吴蕾", "周洋", "唐家萍", "唐铭尉", "孔丽英", "孙阳阳",
    "岳园博", "张恒", "张明", "徐懿泽", "曾杰", "李春黎", "李期位", "杨东",
    "杨振鑫", "杨欢", "梁贞", "潘湛", "王贵", "白星", "聂成", "苏跃华",
    "要津津", "赵娴", "赵婷", "郭艳霞", "陈婧霆", "陈巧巧", "陈梦园", "陈香林",
    "雷东燊",

    # 20260922 新增（审核确认）
    "丁沙沙", "俞卡莉", "张文晓", "徐梓豪", "李金华", "林青", "洪伟", "牛泽毅", "王健民", "胥执强", "黄金辉",

    # 20260923 新增（审核确认）
    "刘慧", "吴剑", "吴蔚", "张可越", "徐江南", "李小虎", "李枫", "杜佳燕", "王卓妮",
    "王振华", "王振姣", "王超", "罗继", "郑少仁", "郭志萍", "陈志恒", "靳小秋",

    # 20260924 新增（审核确认）
    "赵志刚", "江顺航", "张莉", "杨磊", "刘黛", "宋慰", "易盛武", "朱思媛", "李岩", "郑琼",
    "杨婼淇", "王睿之", "刘洋", "胡鲲", "丁蕾", "斯琴图雅", "刘炜玮", "陈建军", "赵斐苗", "张溪荷",
    "陈世清", "刘运策",
...
def _add_author_names(target, raw, strict=False):
    ...
    for name in candidates:
        # “整理”是编校角色标记，不是作者姓名。
        if not name or name in target or name == "整理":
            continue
